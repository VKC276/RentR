(function (global) {
  var STR = {
    sv: {
      ...
      conflictHint: 'Din förfrågan skickades inte. Ingen bokning skapades, du har inte fått något bokningsnummer och inget mejl har skickats. Kalendern nedan är nu uppdaterad.',
      tryAgainSoon: 'Många bokar samtidigt just nu. Ingenting bokades — försök igen om en stund.',
    ...
    en: {
      ...
      conflictHint: 'Your request was not sent. No booking was created, you have not been given a booking number and no email was sent. The calendar below is now up to date.',
      tryAgainSoon: 'A lot of people are booking right now. Nothing was booked — please try again in a moment.',
    ...
    de: {
      ...
      conflictHint: 'Ihre Anfrage wurde nicht gesendet. Es wurde keine Buchung angelegt, Sie haben keine Buchungsnummer erhalten und es wurde keine E-Mail verschickt. Der Kalender unten ist jetzt aktuell.',
      tryAgainSoon: 'Gerade buchen viele gleichzeitig. Es wurde nichts gebucht — bitte versuchen Sie es in einem Moment erneut.',
