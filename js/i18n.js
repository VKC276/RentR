(function (global) {
  var STR = {
    sv: {
      ...
      lookupBtn: 'Sök',
      openDoor: 'Open door',
      openDoorHint: 'Open door öppnar förrådet under giltig hämtnings- eller återlämningsdag.',
      openDoorStepHint: 'Öppna dörren först. Därefter bekräftar du utlämning eller återlämning.',
      selfServicePickupExplain: 'Egen hämtning: 1) Open door 2) Bekräfta utlämning när du tagit utrustningen. Först då registreras den som utlämnad.',
      selfServiceReturnExplain: 'Egen återlämning: 1) Open door 2) Bekräfta återlämning när du ställt tillbaka utrustningen. Först då avslutas bokningen.',
    ...
    en: {
      ...
      lookupBtn: 'Search',
      openDoor: 'Open door',
      openDoorHint: 'Open door unlocks the storage on the valid pickup or return day.',
    ...
    de: {
      ...
      lookupBtn: 'Suchen',
      openDoor: 'Open door',
      openDoorHint: 'Open door öffnet das Lager am gültigen Abhol- oder Rückgabetag.',
      openDoorStepHint: 'Öffnen Sie zuerst die Tür. Bestätigen Sie danach Abholung oder Rückgabe.',
      selfServicePickupExplain: 'Selbstabholung: 1) Open door 2) Abholung bestätigen, wenn Sie die Ausrüstung genommen haben. Erst dann gilt sie als ausgegeben.',
      selfServiceReturnExplain: 'Selbstrückgabe: 1) Open door 2) Rückgabe bestätigen, wenn Sie die Ausrüstung zurückgestellt haben. Erst dann wird die Buchung abgeschlossen.',
