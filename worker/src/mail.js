...
const MAIL_I18N = {
  sv: {
    ...
    doorPassIntro: 'Här är din länk för att öppna entredörren. Knappen fungerar endast under giltighetstiden.',
    labelPeriod: 'Period',
    labelDays: 'Dygn',
  ...
  en: {
    ...
    doorPassIntro: 'Here is your link to open the entrance door. The button only works during the validity period.',
    labelPeriod: 'Period',
    labelDays: 'Days',
    labelPads: 'Equipment',
    labelTotal: 'Total',
  ...
  de: {
    ...
    doorPassIntro: 'Hier ist Ihr Link zum Öffnen der Eingangstür. Die Schaltfläche funktioniert nur während der Gültigkeit.',
